...
class AdversarialDebiasing(Transformer):
        ...
        with tf.variable_scope(self.scope_name):
            ...
            for epoch in range(self.num_epochs):
                ...
                for i in range(num_train_samples//self.batch_size):
                    ...
                    batch_feed_tuple = {self.features_ph: batch_features,
                    ...
                    if self.debias:
                        _, _, pred_labels_loss_value, pred_protected_attributes_loss_vale = self.sess.run([classifier_minimizer,
                                       adversary_minimizer,
                                       pred_labels_loss,
                                       pred_protected_attributes_loss], feed_tuple=batch_feed_tuple)
                        if i % 200 == 0:
                        ...
                        _, pred_labels_loss_value = self.sess.run(
                            [classifier_minimizer,
                             pred_labels_loss], feed_tuple=batch_feed_tuple)
                        if i % 200 == 0:
    ...
    def predict(self, dataset):
        ...
        while samples_covered < num_test_samples:
            ...
            pred_labels += self.sess.run(self.pred_labels, feed_tuple=batch_feed_tuple)[:,0].tolist()
