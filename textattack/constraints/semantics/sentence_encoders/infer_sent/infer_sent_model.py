...
class InferSentModel(nn.Module):
    ...
    def get_word_tuple(self, sentences, tokenize=True):
    ...
    def get_w2v(self, word_tuple):
        ...
        with open(self.w2v_path, encoding="utf-8") as f:
            for line in f:
                ...
                if word in word_tuple:
                    word_vec[word] = np.fromstring(vec, sep=" ")
        print("Found %s(/%s) words with w2v vectors" % (len(word_vec), len(word_tuple)))
        return word_vec
    ...
    def build_vocab(self, sentences, tokenize=True):
        assert hasattr(self, "w2v_path"), "w2v path not set"
        word_tuple = self.get_word_tuple(sentences, tokenize)
        self.word_vec = self.get_w2v(word_tuple)
    ...
    def update_vocab(self, sentences, tokenize=True):
        ...
        # udpate vocabulary
        if word_tuple:
            new_word_vec = self.get_w2v(word_tuple)
